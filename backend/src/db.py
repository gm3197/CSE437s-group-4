...
def insert_receipt_item(receipt_id, price, description, category):
	with connect() as conn:
		cur = conn.cursor()
		cur.execute("INSERT INTO receipt_items (receipt_id, description, price, category) VALUES (%s, %s, %s, %s) RETURNING id", (receipt_id, description, price, category))
		return cur.fetchone()[0]
